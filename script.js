...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cards = document.querySelectorAll('.project-card, .timeline-content, .stat-item');
...
//         showNotification(`${projectName} links will be updated soon!`, 'info');
//     });
// });
...
//     link.addEventListener('click', function(e) {
//         e.preventDefault();
//         const platform = this.querySelector('i').className.includes('github') ? 'GitHub' :
...
//         showNotification(`${platform} profile will be updated soon!`, 'info');
//     });
// });
